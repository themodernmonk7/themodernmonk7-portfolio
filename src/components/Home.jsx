      ...
      <section className=" container mx-auto flex flex-col-reverse xl:flex-row md:justify-between justify-evenly items-center h-screen   relative md:my-32 md:px-20 mt-10">
        ...
        <div className=" flex flex-col justify-start w-full xl:w-1/2 px-5 md:px-0 ">
          ...
          <div className="flex flex-col items-start space-y-10  ">
            <Link
              to="/works"
              className="ease-[cubic-bezier(.77, 0, 0.175, 1)] relative mt-12  flex  w-[210px] transform cursor-pointer  items-center space-x-2 py-1 text-lg font-semibold transition-all duration-500 hover:translate-x-4 md:mt-32 md:w-[210px] md:font-bold"
            >
        ...
        <div className=" relative flex justify-center items-center ">
          ...
          />
          <div className="w-44 h-44 md:w-full md:h-full rounded-full   bg-blue-700 dark:bg-white absolute blur-3xl -z-10 "></div>
        ...
        {/* Social icons */}
        {/* <div className="flex  flex-col space-y-12 absolute -left-28 ">
          {socialLinks.map((item) => {
            return (
              <a
                href={item.url}
                key={item.id}
                className="hover:bg-gray-200 hover:text-black grid place-items-center px-2 py-2 rounded-full "
              >
                {" "}
                {item.icon}
              </a>
